...
THREE.VREffect = function ( renderer, onError ) {
	...
	function fovPortToProjection( fov, rightHanded, zNear, zFar ) {
		...
		// Y offset is negated because this proj matrix transforms from world coords with Y=up, but the NDC scaling has Y=down (thanks D3D?)
		m[ 1 * 4 + 0 ] = 0.0;
